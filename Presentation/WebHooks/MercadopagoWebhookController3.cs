...
namespace poc_mercadopago.Presentation.WebHooks
{
    ...
    /// </summary>
    [ApiController]
    public sealed class MercadopagoWebhookController3 : ControllerBase
    {
        private readonly ILogger<MercadopagoWebhookController3> _logger;
        private readonly IPaymentService _paymentService;
        private readonly IPaymentNotificationService _signalRNotificacionService;

        public MercadopagoWebhookController3(IPaymentService paymentService, ILogger<MercadopagoWebhookController3> logger, IPaymentNotificationService signalRNotificacionService)
        {
            _logger = logger;
        ...
        */
        ...
        [HttpPost("webhooks/mercadopago/deprecated")]
